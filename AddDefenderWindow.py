...
class AddDefenderWindow(tk.Toplevel):

    def __init__(self, defender_list, defender_listbox, root_x, root_y):
        tk.Toplevel.__init__(self)
        self.title('Add Defender')
        self.default_pad = 20
        ...
        self.name_label = ttk.Label(        self, text = 'Defender Name', style = 'default.TLabel')
        ...
        self.add_button = ttk.Button(       self, text = 'Add Defender', style = 'default.TButton',
                                     command = lambda: data_man.add_defender_to_list(defender_list, defender_listbox,
                                                                                    self.name_entry.get(),
